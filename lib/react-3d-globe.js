...
var Globe = function () {
  ...
  Globe.prototype._blink = function _blink(markerMesh, from, to, recursive) {
    ...
    new TWEEN.Tween(from).to(to, duration).easing(TWEEN.Easing.Linear.None).on('update', function () {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setMarkers = function (markers) {
    ...
    var barScale = d3.scaleLinear().domain([minVal, maxVal]).range([2, 1000]);
    var pointScale = d3.scaleLinear().domain([minVal, maxVal]).range([2, 10]);
