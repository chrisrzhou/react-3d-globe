...
var Globe = function () {
  ...
  Globe.prototype._createLight = function _createLight() {
    ...
    var light = new THREE.SpotLight(this.options.light.frontLightColor, this.options.light.frontLightIntensity, this.radius * 10);
  ...
  Globe.prototype._createBacklight = function _createBacklight() {
    ...
    var light = new THREE.SpotLight(this.options.light.backLightColor, this.options.light.backLightIntensity, this.radius * 10);
    light.target.position.set(0, 0, 0);
    this.camera.add(light);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setMarkers = function (markers) {
    ...
    var pointScale = d3.scaleLinear().domain([minVal, maxVal]).range([4, 10]);
    markers.forEach(function (marker) {
      ...
      new TWEEN.Tween({ scale: 0 }).to({ scale: 1 }, 600).easing(TWEEN.Easing.Linear.None).on('update', function () {
